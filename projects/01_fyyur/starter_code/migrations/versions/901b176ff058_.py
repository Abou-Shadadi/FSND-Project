...
Revision ID: 901b176ff058
Revises: 
Create Date: 2022-06-04 15:45:10.291442
...
def upgrade():
    ...
    sa.Column('seeking_description', sa.String(length=160), nullable=True),
    ...
    sa.Column('up_coming', sa.Boolean(), nullable=False),
